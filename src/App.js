...
function App() {
  return (
    <Routes>
      ...
      <Route path="/FirstPage" element={<ProtectedRoute><FirstPage /></ProtectedRoute>} />
      <Route path="/TestProjet" element={<ProtectedRoute><TestProjet /></ProtectedRoute>} />
      <Route path="/FicheProjet" element={<ProtectedRoute><FicheProjet /></ProtectedRoute>} />
      <Route path="/MesArticles" element={<ProtectedRoute><MesArticles /></ProtectedRoute>} />
      <Route path="/GlobalDash" element={<ProtectedRoute><GlobalDash /></ProtectedRoute>} />
      <Route path="/DashDecompte" element={<ProtectedRoute><DashDecompte /></ProtectedRoute>} />
      <Route path="/TabComp" element={<ProtectedRoute><TabComp /></ProtectedRoute>} />
      <Route path="/DashDelais" element={<ProtectedRoute><DashDelais /></ProtectedRoute>} />
      <Route path="/ListeArticle" element={<ProtectedRoute><ListeArticle /></ProtectedRoute>} />
      <Route path="/JournalCHantier" element={<ProtectedRoute><JournalCHantier /></ProtectedRoute>} />
      <Route path="/Delais" element={<ProtectedRoute><Delais /></ProtectedRoute>} />
      <Route path="/Decompte" element={<ProtectedRoute><Decompte /></ProtectedRoute>} />
      <Route path="/DecompteForm" element={<ProtectedRoute><DecompteForm /></ProtectedRoute>} />
      <Route path="/BudgetDashboard" element={<ProtectedRoute><BudgetDashboard /></ProtectedRoute>} />
      <Route path="/DashboardDelai" element={<ProtectedRoute><DashboardDelai /></ProtectedRoute>} />
      <Route path="/Rapport" element={<ProtectedRoute><Rapport /></ProtectedRoute>} />
      <Route path="/ImporterRapport" element={<ProtectedRoute><ImporterRapport /></ProtectedRoute>} />

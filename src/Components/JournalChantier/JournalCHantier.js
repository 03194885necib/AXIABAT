...
export default function JournalChantier() {
  ...
  const validate = () => {
    ...
    if (travaux.some((t) => !t.designation.trim())) return "Remplissez toutes les désignations des travaux.";
    return null;
  };
              ...
              {journaux.map((j) => (
                <div key={j.id} style={s.journalCard}>
                  ...
                  <div style={s.journalStats}>
                    ...
                    <span>🔧 {j.materiel?.length || 0} engins</span>
                    <span>🏗️ {j.travaux?.length || 0} travaux</span>
                  </div>
                  <div style={s.journalFooter}>
                    <span style={s.journalAuthor}>Par : {j.createdByName || "—"}</span>
                    <span style={s.journalHoraires}>{j.horaireDebut} — {j.horaireFin}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div style={s.content}>
          ...
          <div style={s.card}>
            ...
            <div style={s.grid3}>
              ...
              <div style={s.field}>
                ...
                <select name="temps" style={s.input} value={form.temps} onChange={handleFormChange}>
                  {TEMPS_OPTIONS.map((t) => <option key={t} value={t}>{t}</option>)}
                </select>
              </div>
              <div style={s.field}>
          ...
          <div style={{ ...s.card, marginTop: 20 }}>
            <div style={s.sectionHeader}>
              <h2 style={s.sectionTitle}>👷 Personnel</h2>
              <button style={s.btnAdd} onClick={addPersonnel}>+ Ajouter</button>
            </div>
          ...
          <div style={{ ...s.card, marginTop: 20 }}>
            <div style={s.sectionHeader}>
              <h2 style={s.sectionTitle}>🔧 Matériel & Engins</h2>
              <button style={s.btnAdd} onClick={addMateriel}>+ Ajouter</button>
            </div>
            <div style={s.tableWrapper}>
              <table style={s.table}>
                <thead><tr style={s.thead}>
          ...
          <div style={{ ...s.card, marginTop: 20 }}>
            <div style={s.sectionHeader}>
              <h2 style={s.sectionTitle}>📦 Approvisionnement</h2>
              <button style={s.btnAdd} onClick={addAppro}>+ Ajouter</button>
            </div>
            <div style={s.tableWrapper}>
              <table style={s.table}>
                <thead><tr style={s.thead}>
          ...
          <div style={{ ...s.card, marginTop: 20 }}>
            <div style={s.sectionHeader}>
              ...
              <button style={s.btnAdd} onClick={addTravaux}>+ Ajouter</button>
            </div>
            <div style={s.tableWrapper}>
              <table style={s.table}>
                <thead><tr style={s.thead}>
          ...
          {/* Instructions */}
          <div style={{ ...s.card, marginTop: 20 }}>
            <h2 style={s.sectionTitle}>📝 Instructions & Observations</h2>
            <div style={s.grid2}>
              <div style={s.field}>
...
const s = {
  ...
  inputSm: { width: "100%", padding: "6px 8px", border: `1.5px solid ${C.border}`, borderRadius: 6, fontSize: 13, outline: "none", background: C.white },
  textarea: { width: "100%", padding: "9px 12px", border: `1.5px solid ${C.border}`, borderRadius: 8, fontSize: 14, outline: "none", boxSizing: "border-box", background: C.white, resize: "vertical", fontFamily: "inherit" },
  ...
  td: { padding: "8px 12px", fontSize: 14, color: C.text, verticalAlign: "middle" },
  deleteBtn: { background: "none", border: "none", cursor: "pointer", fontSize: 16, color: C.danger, padding: 4 },
  totalRow: { marginTop: 10, fontSize: 13, color: C.muted, textAlign: "right" },
